...
public class ControllerTest {
    ...
    public ControllerTest(String objectName, String objectCaption, Project project, List<FieldDAO> fields,
    ...
    public String makeClass(Project project, Enums.ServiceTypes serviceTypes) throws Exception {
        ...
        String className = objectName + "" + Enums.WebFiles.ControllerTest.name();
